...
export function generateMetadata({ params }: { params: { lang: Locale } }): Metadata {
  ...
  return {
    title: {
      absolute: ru
        ? 'О нас — магазин футбольной экипировки с 2018 | Bootsbaza'
        : 'Про нас — магазин футбольної екіпіровки з 2018 | Bootsbaza',
    },
    description: ru
      ? 'Bootsbaza — интернет-магазин футбольной обуви и экипировки с 2018 года. У нас своя команда, которая играет на турнирах Харькова. Мы сами играем — поэтому разбираемся в обуви.'

...
export interface Dict {
  ...
  checkout: { title: string; errName: string; errCity: string; sendError: string; doneTitle: string; doneText: string; emptyCart: string; name: string; namePh: string; phone: string; city: string; cityPh: string; region: string; warehouse: string; warehousePh: string; loading: string; pickWh: string; pickCityFirst: string; comment: string; commentPh: string; submitting: string; confirm: string; yourOrder: string; payment: string; payCod: string; payPrepay: string; deliveryNote: string; promo: string; promoPh: string; promoApply: string; promoApplied: string; promoInvalid: string; subtotal: string; discount: string; toPay: string };
